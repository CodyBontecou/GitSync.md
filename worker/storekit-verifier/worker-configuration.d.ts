...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUNDLE_ID" | "APP_APPLE_ID" | "ENABLE_ONLINE_CHECKS" | "ALLOWED_ENVIRONMENTS" | "MAX_JWS_BYTES">> {}
}

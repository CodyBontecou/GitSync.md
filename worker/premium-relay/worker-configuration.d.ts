/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 95357e2898c2e81e1895477ca7124542)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	OUTBOX_QUEUE: Queue;
	BUNDLE_ID: "bontecou.Sync-md";
	PRODUCT_IDS: "com.bontecou.gitsync.assist.monthly,com.bontecou.gitsync.assist.annual";
	APP_STORE_ENVIRONMENTS: "Sandbox,Production";
	GITHUB_APP_ID: "4687322";
	GITHUB_APP_SLUG: "gitsync-md-assist";
	GITHUB_CALLBACK_URL: "https://gitsync-premium-relay.costream.workers.dev/v1/github/callback";
	GITHUB_AUTHORIZATION_CALLBACK_URL: "https://gitsync-premium-relay.costream.workers.dev/v1/github/authorize/callback";
	APNS_TEAM_ID: "67KC823C9A";
	APNS_KEY_ID: "V76THLWH9L";
	...
	KILL_SWITCH: "false";
	STOREKIT_VERIFIER: Fetcher /* storekit-verifier */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUNDLE_ID" | "PRODUCT_IDS" | "APP_STORE_ENVIRONMENTS" | "GITHUB_APP_ID" | "GITHUB_APP_SLUG" | "GITHUB_CALLBACK_URL" | "GITHUB_AUTHORIZATION_CALLBACK_URL" | "APNS_TEAM_ID" | "APNS_KEY_ID" | "APNS_TOPIC" | "SESSION_TTL_SECONDS" | "LINK_STATE_TTL_SECONDS" | "WEBHOOK_RETENTION_DAYS" | "NOTIFICATION_RETENTION_DAYS" | "KILL_SWITCH">> {}
}
